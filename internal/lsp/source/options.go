...
import (
	...
	"github.com/dwahler/go-tools/go/analysis/passes/atomicalign"
	...
	"github.com/dwahler/go-tools/go/analysis/passes/deepequalerrors"
	"github.com/dwahler/go-tools/go/analysis/passes/errorsas"
	"github.com/dwahler/go-tools/go/analysis/passes/fieldalignment"
	"github.com/dwahler/go-tools/go/analysis/passes/httpresponse"
	"github.com/dwahler/go-tools/go/analysis/passes/ifaceassert"
	...
	"github.com/dwahler/go-tools/go/analysis/passes/nilness"
	"github.com/dwahler/go-tools/go/analysis/passes/printf"
	"github.com/dwahler/go-tools/go/analysis/passes/shadow"
	"github.com/dwahler/go-tools/go/analysis/passes/shift"
	"github.com/dwahler/go-tools/go/analysis/passes/sortslice"
	"github.com/dwahler/go-tools/go/analysis/passes/stdmethods"
	"github.com/dwahler/go-tools/go/analysis/passes/stringintconv"
	"github.com/dwahler/go-tools/go/analysis/passes/structtag"
	"github.com/dwahler/go-tools/go/analysis/passes/testinggoroutine"
	...
	"github.com/dwahler/go-tools/go/analysis/passes/unusedwrite"
	"github.com/dwahler/go-tools/go/packages"
	"github.com/dwahler/go-tools/internal/lsp/analysis/embeddirective"
	"github.com/dwahler/go-tools/internal/lsp/analysis/fillreturns"
	"github.com/dwahler/go-tools/internal/lsp/analysis/fillstruct"
	"github.com/dwahler/go-tools/internal/lsp/analysis/infertypeargs"
	"github.com/dwahler/go-tools/internal/lsp/analysis/nonewvars"
	"github.com/dwahler/go-tools/internal/lsp/analysis/noresultvalues"
	"github.com/dwahler/go-tools/internal/lsp/analysis/simplifycompositelit"
	"github.com/dwahler/go-tools/internal/lsp/analysis/simplifyrange"
	"github.com/dwahler/go-tools/internal/lsp/analysis/simplifyslice"
	"github.com/dwahler/go-tools/internal/lsp/analysis/stubmethods"
	"github.com/dwahler/go-tools/internal/lsp/analysis/undeclaredname"
	"github.com/dwahler/go-tools/internal/lsp/analysis/unusedparams"
	"github.com/dwahler/go-tools/internal/lsp/analysis/useany"
	"github.com/dwahler/go-tools/internal/lsp/command"
	"github.com/dwahler/go-tools/internal/lsp/diff"
	"github.com/dwahler/go-tools/internal/lsp/diff/myers"

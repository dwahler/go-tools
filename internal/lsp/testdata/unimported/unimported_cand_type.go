...
import (
	...
	"github.com/dwahler/go-tools/internal/lsp/baz"
	_ "github.com/dwahler/go-tools/internal/lsp/signature" // provide type information for unimported completions in the other file
)

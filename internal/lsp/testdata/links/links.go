...
import (
	...
	"github.com/dwahler/go-tools/internal/lsp/foo" //@link(`github.com/dwahler/go-tools/internal/lsp/foo`,`https://pkg.go.dev/github.com/dwahler/go-tools/internal/lsp/foo?utm_source=gopls`)

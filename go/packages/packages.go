...
import (
	...
	"github.com/dwahler/go-tools/go/gcexportdata"
	"github.com/dwahler/go-tools/internal/gocommand"
	"github.com/dwahler/go-tools/internal/packagesinternal"
...
func (ld *loader) loadFromExportData(lpkg *loaderPackage) (*types.Package, error) {
	...
	if viewLen != len(view) {
		log.Panicf("github.com/dwahler/go-tools/go/packages: unexpected new packages during load of %s", lpkg.PkgPath)
	}

...
import (
	...
	"github.com/dwahler/go-tools/refactor/importgraph"

	_ "crypto/hmac" // just for test, below
)

const this = "github.com/dwahler/go-tools/refactor/importgraph"

func TestBuild(t *testing.T) {
	exported := packagestest.Export(t, packagestest.GOPATH, []packagestest.Module{
		{Name: "github.com/dwahler/go-tools/refactor/importgraph", Files: packagestest.MustCopyFileTree(".")}})

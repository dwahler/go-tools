...
import (
	...
	"github.com/dwahler/go-tools/internal/lsp/command/commandmeta"
	"github.com/dwahler/go-tools/internal/lsp/mod"
...
func rewriteAPI(_ []byte, api *source.APIJSON) ([]byte, error) {
	...
	fmt.Fprintf(&buf, "// Code generated by \"github.com/dwahler/go-tools/gopls/doc/generate\"; DO NOT EDIT.\n\npackage source\n\nvar GeneratedAPIJSON = ")
	if err := printsrc.NewPrinter("github.com/dwahler/go-tools/internal/lsp/source").Fprint(&buf, api); err != nil {
		return nil, err
	}

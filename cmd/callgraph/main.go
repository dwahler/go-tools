...
package main // import "github.com/dwahler/go-tools/cmd/callgraph"
...
import (
	...
	"github.com/dwahler/go-tools/go/callgraph/rta"
	"github.com/dwahler/go-tools/go/callgraph/static"
	"github.com/dwahler/go-tools/go/packages"
	"github.com/dwahler/go-tools/go/pointer"
...
-format    Specifies the format in which each call graph edge is displayed.
           One of:
            ...
            digraph     output suitable for input to
                        github.com/dwahler/go-tools/cmd/digraph.
...
Examples:
  ...
  Show all functions directly called by the callgraph tool's main function:
    ...
    callgraph -format=digraph github.com/dwahler/go-tools/cmd/callgraph |
      digraph succs github.com/dwahler/go-tools/cmd/callgraph.main
`
